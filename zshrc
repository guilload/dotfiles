...
# Fix /usr/bin occurs before /usr/local/bin (Homebrew)
...
plugins=(git pip python sublime vagrant virtualenvwrapper)
...
# scheme
alias guile-scheme="rlwrap guile"
alias mit-scheme="rlwrap -r -c -f ~/.mit-scheme/bindings.txt scheme"
